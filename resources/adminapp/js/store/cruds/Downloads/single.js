function initialState() {
  ...
  const actions = {
    ...
    insertDownloadFile({ commit }, file) {
      commit('insertDownloadFile', file)
    },
    removeDownloadFile({ commit }, file) {
      commit('removeDownloadFile', file)
    },
  ...
  const mutations = {
    ...
    insertDownloadFile(state, file) {
      state.entry.download.push(file)
    },
    removeDownloadFile(state, file) {
      state.entry.download = state.entry.download.filter(item => {
